...
#x <- sapply(s2, function(s) sapply(n, function(c) cbind(rnorm(c, m1, s1), rnorm(c, m2, s2))))
```
...
levelplot(r1~x*y, grid, xlab="n", ylab="sigma_2", main="p-value for Fisher test (mean for 1000 experiments)")
levelplot(r2~x*y, grid, xlab="n", ylab="sigma_2", main="p-value for Ansari-Bradley test (mean for 1000 experiments)")
